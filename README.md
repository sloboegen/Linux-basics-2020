...
3) Для того, чтобы сдать задание создаете pull request в danyaberezun:Linux-basics-2020:master (NB: перед открытием pull request проверьте, что преподаватель не внес изменений; если надо --- сначала получите их (см. инструкцию ниже))
